...
export function AuthPage({ initialMode = "signup" }: { initialMode?: "login" | "signup" }) {
  ...
  const subtitle = useMemo(
    () =>
      mode === "signup"
        ? "Join thousands of creators building with Klin"
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          >
            ...
            <motion.div
              variants={{
                hidden: { opacity: 0, x: mode === "signup" ? -100 : 100 },
                visible: { opacity: 1, x: 0, transition: { duration: 0.6, ease: "easeOut" } },
              }}
              className={mode === "signup" ? "flex flex-col gap-8 p-8 sm:p-10 lg:w-1/2" : "flex flex-col gap-6 bg-gradient-to-b from-white to-[#FAFBFC] p-8 sm:p-10 lg:w-1/2 lg:justify-between"}
            >
              {mode === "signup" ? (
                <>
                  {/* SIGNUP FORM */}
                    ...
                    <button
                      ...
                      className={`rounded-full px-4 py-2 text-sm font-semibold transition ${
                        mode === "signup"
                          ...
                          : "bg-[#F4F6FB] text-[#0F1020]/70 hover:bg-[#E9ECFC]"
                      }`}
                    >
                      Sign up
                    </button>
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-base text-[#0F1020]/60">{subtitle}</p>
                  </div>
                  ...
                  <form className="space-y-3" onSubmit={handleEmailSubmit}>
                    <label className="block space-y-2 text-sm">
                      <span className="text-[#0F1020]/70 font-medium">Full name</span>
                      <div className="relative">
                        <User className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-[#0F1020]/30" />
                        <Input
                          type="text"
            ...
            <motion.div
              ...
              className={mode === "signup" ? "flex flex-col gap-6 bg-gradient-to-b from-white to-[#FAFBFC] p-8 sm:p-10 lg:w-1/2 lg:justify-between" : "flex flex-col gap-8 p-8 sm:p-10 lg:w-1/2"}
            >
              {mode === "signup" ? (
                <>
                  {/* SIGNUP IMAGES */}
